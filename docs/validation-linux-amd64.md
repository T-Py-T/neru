...
6. **If a box prints an error, stop** and check [section 12 (common gotchas)](#12-common-gotchas-on-x86_64) before continuing.

> Not sure which guide you need? Run `uname -m`. If it prints `x86_64`, you're in the right place. If it prints `aarch64`, use [validation-linux-arm64.md](./validation-linux-arm64.md) instead.
